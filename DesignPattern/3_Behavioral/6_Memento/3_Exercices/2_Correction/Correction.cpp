...
namespace
{
    ...
    TEST_F(Evaluate, TwoTokenTest)
    {
        ...
        ASSERT_EQ(1, tm.tokens[0]->value) << "First toke should have value 1, you got " << tm.tokens[0]->value;
    ...
    TEST_F(Evaluate, FiddledTokenTest)
    {
        ...
        ASSERT_EQ(111, tm.tokens[0]->value) << "You got the token value wrong here. "
